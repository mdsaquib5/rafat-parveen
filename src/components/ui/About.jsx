                    ...
                    <div className="about-content">
                        ...
                        <div className="story-slider">
                            <div className="story-img">
                                <Image src="/story-1.png" alt="story" width={640} height={800} priority />
                            </div>
                            <div className="story-img">
                                <Image src="/story-2.png" alt="story" width={640} height={800} priority />
                            </div>
                            <div className="story-img">
                                <Image src="/story1-3.png" alt="story" width={640} height={800} priority />
                            </div>
                            <div className="story-img">
                                <Image src="/story-4.png" alt="story" width={640} height={800} priority />
                            </div>
                            <div className="story-img">
                                <Image src="/story-5.png" alt="story" width={640} height={800} priority />
                            </div>
                            <div className="story-img">
                                <Image src="/story-6.jpeg" alt="story" width={640} height={800} priority />
                            </div>
                        </div>
                    </div>
                    <div className="about-img">
                        <Image src="/rafat-main.jpg" alt="main-story" width={640} height={640} priority />
                    </div>
                </div>
            </div>
        </section>
